...
class OeuvreController extends AbstractController
{
    ...
    #[Route('/front', name: 'app_oeuvre_index_front', methods: ['GET'])]
    public function index_front(OeuvreRepository $oeuvreRepository): Response
    {
        return $this->render('oeuvre/list_front.html.twig', [
            'oeuvres' => $oeuvreRepository->findAll(),
        ]);
    }
